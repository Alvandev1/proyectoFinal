...
public class Juego10 extends JFrame {
	 ...
	 */
	public Juego10() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Juego10.class.getResource("/imagenes/ChatGPT.png")));
		setTitle("LionGame");
		...
		trailerButton.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e) {
		        try {
		            // URL del trailer
		            URI trailerLink = new URI("https://www.youtube.com/watch?v=NXTlh31ZWZ4");
		...
		JLabel tituloLabel = new JLabel("Grand Theft Auto V Enhanced");
		tituloLabel.setBounds(10, 23, 545, 34);
		tituloLabel.setForeground(Color.WHITE);
		tituloLabel.setFont(new Font("Verdana", Font.BOLD, 28));
		contentPane.add(tituloLabel);
		
		JLabel anuncioLabel = new JLabel("Grand Theft Auto V Enhanced");
		...
		ImageIcon icono2=new ImageIcon(PlayStation.class.getResource("/imagenes/mariowonder.jpg"));
		...
		imagenLabel.setIcon(new ImageIcon(Juego10.class.getResource("/imagenes/gtas.jpg")));
		...
		descripcionLabel.setText("Disfruta de los superventas del\r\nentretenimiento Grand Theft\r\nAuto V, ahora mejorados para\r\nuna nueva generación, con\r\nimpresionantes gráficos, carga\r\nmás rápida, audio 3D y mucho\r\nmás, además de contenido\r\nexclusivo para los jugadores de\r\nGTA Online.");
		descripcionLabel.setBounds(466, 107, 330, 238);

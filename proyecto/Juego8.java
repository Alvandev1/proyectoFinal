...
public class Juego8 extends JFrame {
	 ...
	 */
	public Juego8() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Juego8.class.getResource("/imagenes/ChatGPT.png")));
		setTitle("LionGame");
		...
		trailerButton.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e) {
		        try {
		            // URL del trailer
		            URI trailerLink = new URI("https://www.youtube.com/watch?v=sZNeut6RR4I");
		...
		JLabel tituloLabel = new JLabel("Super Mario Party Jamboree");
		tituloLabel.setBounds(10, 23, 456, 34);
		tituloLabel.setForeground(Color.WHITE);
		tituloLabel.setFont(new Font("Verdana", Font.BOLD, 28));
		contentPane.add(tituloLabel);
		
		JLabel anuncioLabel = new JLabel("Comprar Super Mario Party Jamboree");
		...
		descripcionLabel.setText("¡Celebra una fiesta por todo lo\r\nalto en Super Mario Party \r\nJamboree para Nintendo \r\nSwitch! Reúne a tu familia y\r\namigos, y divertíos de lo lindo\r\nen siete tableros, tanto nuevos\r\ncomo conocidos. \r\ntrocea, rebana y monta todo");

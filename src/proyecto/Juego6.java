...
public class Juego6 extends JFrame {
	 ...
	 */
	public Juego6() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Juego6.class.getResource("/imagenes/ChatGPT.png")));
		setTitle("LionGame");
		...
		trailerButton.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e) {
		        try {
		            // URL del trailer
		            URI trailerLink = new URI("https://www.youtube.com/watch?v=qx0A921z8mA");
		...
		imagenLabel.setIcon(new ImageIcon(Juego6.class.getResource("/imagenes/nba.jpg")));
		...
		descripcionLabel.setText("Conviértete en el rey de la pista\r\ncon autenticidad y realismo con\r\nProPLAY™, que te permitirá \r\ntener el control absoluto de tu\r\njuego en NBA 2K25. Define tu\r\nlegado en Mi CARRERA,\r\nMyTEAM, MiNBA y La W.");
		descripcionLabel.setBounds(466, 149, 330, 212);

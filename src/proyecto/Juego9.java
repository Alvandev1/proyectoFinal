...
public class Juego9 extends JFrame {
	 ...
	 */
	public Juego9() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Juego9.class.getResource("/imagenes/ChatGPT.png")));
		setTitle("LionGame");
		...
		trailerButton.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e) {
		        try {
		            // URL del trailer
		            URI trailerLink = new URI("https://www.youtube.com/watch?v=GZO7MgHNqI4");
		...
		JLabel tituloLabel = new JLabel("Super Mario Wonder");
		tituloLabel.setBounds(10, 23, 456, 34);
		tituloLabel.setForeground(Color.WHITE);
		tituloLabel.setFont(new Font("Verdana", Font.BOLD, 28));
		contentPane.add(tituloLabel);
		
		JLabel anuncioLabel = new JLabel("Comprar Super Mario Wonder");
		...
		descripcionLabel.setText("El Príncipe Florian invita a Mario\r\ny sus amigos a que lo visiten,\r\npero ¡un conocido enemigo\r\naparece entonces por sorpresa!\r\nMientras su ejército les estropea\r\nla fiesta a nuestros héroes, \r\nBowser se apodera de una Flor\r\nMaravilla y se fusiona con el\r\ncastillo del Príncipe Florian,\r\ntransformándose en una \r\nfortaleza flotante.");

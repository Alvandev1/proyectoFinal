...
public class Juego4 extends JFrame {
	 ...
	 */
	public Juego4() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Juego4.class.getResource("/imagenes/ChatGPT.png")));
		setTitle("LionGame");
		...
		trailerButton.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e) {
		        try {
		            // URL del trailer
		            URI trailerLink = new URI("https://www.youtube.com/watch?v=vovkzbtYBC8");
		...
		JLabel tituloLabel = new JLabel("Assassin’s Creed Shadows");
		tituloLabel.setBounds(10, 23, 446, 34);
		tituloLabel.setForeground(Color.WHITE);
		tituloLabel.setFont(new Font("Verdana", Font.BOLD, 28));
		contentPane.add(tituloLabel);
		
		JLabel anuncioLabel = new JLabel("Comprar Assassin’s Creed Shadows");
		...
		descripcionLabel.setText("¡Entra en una épica historia de \r\nacción y aventura ambientada\r\nen el Japón feudal! Explora un\r\nfascinante mundo abierto\r\ndurante una época turbulenta\r\nen la piel de una letal Assassin\r\nshinobi y un legendario y\r\npoderoso samurái.");
